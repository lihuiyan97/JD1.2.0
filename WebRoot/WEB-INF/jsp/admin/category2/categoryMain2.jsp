...
<html>
			...
			<table id="categoryTable" class="table table-striped table-bordered table-hover">
				<thead>
					<tr class="tableHead">
						...
						<th width="35%">商品种类描述</th>
						<th width="15%">所属一级商品种类</th>
						<th width="10%">操作</th>
						<th width="10%">操作</th>
					</tr>
				</thead>
				...
				<tbody>
					...
					%>
						...
						<tr>
							...
							<td><%=category.getCname2() %></td>
							<td><%=category.getCdesc2() %></td>
	...
	<a id="first" class="btn btn-default btn-sm" href="Category2Servlet?action=getPageByQuery&searchCondition=${requestScope.searchCondition}&requestPage=1">首页</a>
    
    
    <a id="previous" class="btn btn-default btn-sm" href="Category2Servlet?action=getPageByQuery&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getPreviousPage()%>"> 上一页</a>
      <a id="next" class="btn btn-default btn-sm" href="Category2Servlet?action=getPageByQuery&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getNextPage()%>"> 下一页</a>
    ...
    <span>页 </span>
		...
		<script type="text/javascript">
			...
			function getOneForUpdate(id){
				...
				location.assign("Category2Servlet?action=getOneForUpdate&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getCurrentPage()%>&cid=" + id);
			}
